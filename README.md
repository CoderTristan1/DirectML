...
- If your PC runs Windows 11, version 24H2 (build 26100) or later, consider using [Windows ML](https://learn.microsoft.com/en-us/windows/ai/new-windows-ml/overview) for accelerated machine learning model execution.e
